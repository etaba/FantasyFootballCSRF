"""
Django settings for FantasyFootballCSRF project.
...
SECRET_KEY = 'o-*0fyd^g7k=wl1t9#1r(y&-f=1i*xi&9-*5bc%(s5*%ht63w@'
...
ROOT_URLCONF = 'FantasyFootballCSRF.urls'
...
WSGI_APPLICATION = 'FantasyFootballCSRF.wsgi.application'
...
if os.environ.get('PRODUCTION') is False:
